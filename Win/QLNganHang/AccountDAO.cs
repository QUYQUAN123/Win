...
namespace QLNganHang
{
    public class AccountDAO
    {
        ...
        {
            string query = string.Format("INSERT dbo.Account ( UserName,CitizenID, Type, password )VALUES  ( N'{0}', N'{1}', {2}, N'{3}')", name, displayName, type, "1962026656160185351301320480154111117132155");
        ...
        {
            string query = string.Format("UPDATE dbo.Account SET CitizenID = N'{1}', Type = {2} WHERE UserName = N'{0}'", name, displayName, type);
            int result = DataProvider.Instance.ExecuteNonQuery(query);
